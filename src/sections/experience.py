...
def experience_section():
        ...
        with st.form("experience_form"):
            ...
            with col2:
                start_date = st.date_input(
                    "Start Date",
                    help="When you started this position"
                )
            ...
            job_type = st.selectbox(
                "Job Type",
                ["Full-time", "Part-time", "Contract", "Internship", "Fellowship", "Postdoc"],
    ...
    if experience_list:
        ...
        st.info("No work experience entries added yet. Use the form above to add your professional experience.")
