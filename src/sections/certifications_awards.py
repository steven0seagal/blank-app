        ...
        with st.form("certification_form"):
            ...
            with col1:
                cert_name = st.text_input(
                    "Certification Name",
                    help="Full name of the certification"
                )
            ...
            with col2:
                issue_date = st.date_input(
                    "Issue Date",
                    help="When the certification was issued"
                )
                ...
                no_expiry = st.checkbox(
                    "No Expiry Date",
                    help="Check if certification doesn't expire"
                )
            ...
            if st.form_submit_button("Add Certification", type="primary"):
                ...
                if not cert_name.strip() or not issuing_org.strip():
                    st.error("Certification name and issuing organization are required.")
                else:
        ...
        with st.form("award_form"):
            ...
            with col1:
                award_name = st.text_input(
                    "Award Name",
                    help="Name of the award or honor"
                )
                awarding_org = st.text_input(
                    "Awarding Organization",
                    help="Organization that gave the award"
                )

            with col2:
                award_date = st.date_input(
                    "Date Received",
                    help="When you received the award"
                )
