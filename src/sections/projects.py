...
def projects_section():
        ...
        with st.form("project_form"):
            ...
            with col1:
                project_name = st.text_input(
                    "Project Name", help="Name of your project or research"
                )
            ...
            with col2:
                ...
                ongoing = st.checkbox(
                    "Ongoing Project", help="Check if the project is still in progress"
                )
    ...
    if projects_list:
            ...
            with st.container():
                ...
                with col1:
                    ...
                    if project["publication_link"]:
                        st.write(
                            f"📄 [Publication/Demo]({project['publication_link']})"
                        )
        ...
        st.info(
            "No projects added yet. Use the form above to showcase your research and development work."
        )
